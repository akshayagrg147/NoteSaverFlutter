      ...
      body: ValueListenableBuilder<Box<NotesModal>>(
          ...
          builder: (context, box, _) {
            ...
            return
              ...
              Column(
                children: [
                  //266 Text((MediaQuery.of(context).size.height/2).toString(),style: TextStyle(color: Colors.black),),
                  Container(
                    height: ((MediaQuery.of(context).size.height)/2)-50-80,
                    // color: Colors.yellow,
                  ),
                  Container(
                    height: 105,
            ...
            IconButton(
                onPressed: () {
                  ...
                  deliveriesMap.forEach((key, value) {
                    if (value.cardholder ==
                        box.values.take(index + 1).last.cardholder) {
                      desiredKey = key;
                    }
                  });
