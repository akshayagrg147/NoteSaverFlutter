            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  ? Text("Hey, User!",style: Theme.of(context).textTheme.subtitle1?.copyWith(color: fontDark))
                      : Text("$firstname $lastname",style: Theme.of(context).textTheme.subtitle1?.copyWith(color: fontDark))
                ),
                Center(
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("₹${_totalIncome(data: data,length: box.length) - _totalExpense(data: data,length: box.length)}",
                        ...
                        children: [
                          Flexible(
                            child: IncomeExpenseCard(
                                bgColor: primaryDark,
                                label: "Income",
                                balance: _totalIncome(data: data,length: box.length).toString(),
                          ...
                          Flexible(
                            child: IncomeExpenseCard(
                                bgColor: accent,
                                label: "Expenses",
                                balance:"-${_totalExpense(data: data,length: box.length)}",
